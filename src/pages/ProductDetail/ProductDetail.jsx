...
import { Categories, Product, About, Footer } from "../../components";
...
const ProductDetail = () => {
  ...
  const recommendedProducts = targetProduct.others.map((product) => {
    ...
    return (
      <Product
        ...
        images={images}
        category={
          product.slug.slice(product.slug.lastIndexOf("-") + 1) +
          (product.slug.endsWith("r") ? "s" : "")
        }
        type="recommended"
      />
    );
  ...
  const inTheBoxItems = targetProduct.includes.map((item) => (
    <li key={nanoid()} className="flex gap-6">
  ...
  return (
    <>
      ...
      >
        <section className="flex flex-col">
          ...
          >
            <picture>
              ...
              />
              <img
                className="max-w-[20.4rem] rounded-lg
                             md:max-w-[17.6rem]
                               lg:max-w-[33.75rem]"
        ...
        <section
          className="flex flex-col gap-[5.5rem]
                       md:gap-[7.5rem] 
                         lg:flex-row"
        >
          <div>
            ...
            <p
              className="whitespace-pre-line text-[0.9375rem] font-medium leading-relaxed opacity-50
                           lg:max-w-[39.6875rem]"
            >
        ...
        <section
          className="mb-20 flex flex-col items-center gap-14
                       md:mb-0"
        >
          <h2
            className="-mb-4 mt-7 text-2xl font-bold uppercase
