...
const ConfirmationModal = ({ grandTotal }) => {
  ...
  return (
    <aside className="fixed top-0 z-50 flex h-screen w-full flex-col justify-center bg-black bg-opacity-40 px-6">
      <div
        role="dialog"
        className="mx-auto flex max-w-[20.4375rem] flex-col gap-8 rounded-lg bg-white px-8 pb-[1.9375rem] pt-8
      ...
      >
        ...
        <div>
          <h1
            className="mb-4 text-2xl font-bold uppercase leading-7 tracking-[0.05rem] text-black
        ...
        <div className="md:flex">
          <div
            className="rounded-t-lg bg-seashell px-6 py-6
          ...
          >
            ...
            {REMAINING_ITEMS > 0 && (
              <>
                <div>
                  <hr className="mb-3 mt-2 md:mt-1" />
                </div>
          ...
          <div
            className="rounded-b-lg bg-black
        ...
        <Link
          to={"/"}
          className="btn block bg-raw-sienna text-center text-white hover:bg-[#FBAF85]
                       md:mt-3"
          onClick={clearCart}
        >
          Back to home
