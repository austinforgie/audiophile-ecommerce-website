...
const Hero = () => (
  ...
  >
    ...
    >
      <h1
        className="mb-6 text-4xl uppercase tracking-[0.08rem]
                     md:text-[3.5rem] md:leading-[3.625rem] md:tracking-[0.125rem]"
      >
        <span
          className="mb-4 block text-sm font-normal tracking-[0.625rem] opacity-50
                       md:mb-6"
        >
          New product
        </span>
      ...
      <p
        className="mb-[1.7rem] text-[0.94rem] font-medium leading-6 opacity-75
                     md:mb-10 md:px-4
