...
const Footer = () => {
  ...
  return (
    <div className="bg-cod-gray">
      <footer
        className="relative mx-auto flex list-none flex-col items-center gap-[3.1rem] bg-cod-gray px-6 pb-8 pt-[3.2rem] text-center text-white
      ...
      >
        ...
        <p
          className="max-w-[32rem] text-[0.9375rem] opacity-50
                       md:max-w-[43rem]
                         lg:max-w-[33.75rem]"
        >
        ...
        <div
          className="flex w-full flex-col items-center gap-[3.1rem]
                       md:flex-row md:justify-between"
        >
          <div
            className="text-[0.9375rem] font-bold leading-[1.5625rem] text-white opacity-50
                         md:mt-12
                           lg:mt-6"
          >
